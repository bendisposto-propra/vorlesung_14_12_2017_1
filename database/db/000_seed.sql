...
--
-- Host: 127.0.0.1    Database: ziegel24_de_back
-- ------------------------------------------------------
...
CREATE TABLE `Bestellposition` (
  ...
  KEY `fk_Bestellposition_Bestellung1_idx` (`bestellung`),
  CONSTRAINT `fk_Bestellposition_Bestellung1` FOREIGN KEY (`bestellung`) REFERENCES `Bestellung` (`bestnr`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Bestellposition_Produkte1` FOREIGN KEY (`produkt`) REFERENCES `Produkte` (`produktnr`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Bestellposition` VALUES (1,2,612),(2,2,86),(3,1,60),(4,1,120);
...
INSERT INTO `Bestellung` VALUES (1,'2017-07-07',4),(2,'2017-07-09',16);
...
-- Dump completed on 2017-12-06 17:06:37
